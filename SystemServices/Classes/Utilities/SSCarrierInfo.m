...
+ (NSString *)carrierName {
    ...
    @try {
        ...
        // 当手机插过卡, 拔出来以后 CarrierName 默认读的是上一个, 还需要判断 mobileNetworkCode 是否存在
        // https://developer.apple.com/documentation/coretelephony/ctcarrier/1620313-carriername
        if (CarrierName == nil || CarrierName.length <= 0 || !Carrier.mobileNetworkCode) {
            // Return unknown
            return nil;
        }
